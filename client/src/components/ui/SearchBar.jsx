    ...
    <>
      <div className="flex w-4/6 overflow-hidden rounded-full border border-gray-400 bg-gray-300 shadow-sm hover:shadow-lg md:w-1/2">
        <div className="grow">
          <input
            type="search"
            placeholder="የት መከራየት ይፈልጋሉ?"
            className="h-full w-full border-none px-4 py-2 text-sm  focus:outline-none md:text-lg"
            onChange={(e) => handleSearch(e)}
            value={searchText}
          />
        </div>
        <div className="bg-blue flex cursor-pointer  items-center bg-[#D746B7] text-white">
          <button
            className="flex rounded-r-full bg-[#D746B7] px-4 py-2 md:p-2"
          ...
          >
            ...
            <span className="ml-1 hidden md:block">ይፈልጉ</span>
          </button>
        </div>
      </div>
    </>
